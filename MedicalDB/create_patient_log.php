...
<h3> <center> Please Create a Username and Password </center> </h3>
    ...
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
				<label><br><label>
                <input type="submit" a href  = "create_patient.php" class="btn btn-primary" value="Submit">
                <input type="reset" class="btn btn-default" value="Reset">
            </div>
            <p>Already have an account? <a href="exist_pt.php">Login here</a>.</p>
        </form>
    </div>  </center>	
</body>
